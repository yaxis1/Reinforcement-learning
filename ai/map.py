...
brain = Dqn(5,3,0.9) # 5 sensors, 4 actions, gama = 0.9
action2rotation = [0,20,-20] # action = 0 => no rotation, action = 1 => rotate 20 degres, action = 2 => rotate -20 degres, action = 3 => reverse -10 
